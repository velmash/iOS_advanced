...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.paramEmail.font = UIFont.systemFont(ofSize: 23)
        self.paramEmail.borderStyle = .roundedRect
        self.paramEmail.textAlignment = NSTextAlignment.right // 오른쪽 정렬
        self.paramEmail.adjustsFontSizeToFitWidth = true // 글을 많이 쓰면 칸 크기에 맞게 글자가 작아짐
        self.paramEmail.placeholder = "이메일 예) hyengchan@gmail.com" // placeholder
        ...
        self.paramInterval.maximumValue = 100 // 2. 스테퍼가 가질 수 있는 최소값
        ...
        let customFont = UIFont(name: "SDMiSaeng", size: 24)
        self.txtUpdate.font = customFont
        self.txtUpdate.textColor = UIColor.red // 1. 텍스트의 색상 결정
        ...
        // 전송 버튼을 네비게이션 아이템에 추가하고, submit 메소드에 연결한다.
