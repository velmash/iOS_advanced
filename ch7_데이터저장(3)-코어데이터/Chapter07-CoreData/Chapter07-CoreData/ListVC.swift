...
class ListVC: UITableViewController {
    ...
    func fetch() -> [NSManagedObject] {
        ...
        // 3-1. 정렬 속성 설정
        let sort = NSSortDescriptor(key: "regdate", ascending: false) // 내림차순
    ...
    func save(title: String, contents: String) -> Bool {
        ...
        do {
            ...
            self.list.insert(object, at: 0) // 새 게시글 등록시 제일 위에 뜨도록
            return true
        } catch {
            context.rollback()
            return false
