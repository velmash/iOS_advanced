...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var curruntTime: UILabel!
    @IBAction func callCurruntTime(_ sender: Any) {
        do {
            ...
            // 2. 읽어온 값을 레이블에 표시
            self.curruntTime.text = response
            self.curruntTime.sizeToFit()
